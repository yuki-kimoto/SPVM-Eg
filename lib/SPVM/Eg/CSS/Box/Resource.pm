package SPVM::Eg::CSS::Box::Resource;
...
SPVM::Eg::CSS::Box::Resource - Short Description

=head1 Description

The Eg::CSS::Box::Resource resource in L<SPVM> is a L<resouce|SPVM::Document::Resource> to do someting.
